<template>
    <div class="container-fluid">
        ...
        <div class="pad-eq30">
            ...
            <div class="row">
                <div class="questions-container">
                    <div
                        ...
                        v-for="(item, key) in past_questions"
                        :key="'past' + key"
                    >
            ...
            <div class="row">
                <div class="fluidbtns mt-3" v-if="questions.length > 0">
                    <b-button
                        pill
...
import QuestionsForm from "../../components/writing/Questions/QuestionsForm.vue";
...
export default {
    ...
    beforeMount() {
        ...
        if (this.file) {
            ...
            this.past_questions = this.file.contents;
    ...
    methods: {
        ...
        removeItem_past(idx) {
            this.past_questions.splice(idx, 1);
        },
        ...
        async refreshMessage(item = undefined) {
            ...
            try {
                const {
                    data: { results },
                } = await http().post("/doc/generate-question",
                    {
						...this.baseData,
        ...
        generatedQuestion({ results, baseData }) {
        ...
        downloadMessage(item) {
            downloadDoc(item, "Generated Question");
        },
        ...
        download_results() {
            let results = [...this.past_questions, ...this.questions];
...
.question-item .item-title textarea:hover {
    background: #e6e6e6;
}
.form-control:focus {
    color: #495057;
