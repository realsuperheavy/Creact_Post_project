                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <span
                                        v-if="addModal.errorMessage"
                                        class="text-danger"
                                        >{{ addModal.errorMessage }}</span
                                    >
                                    <form
                                        class="custom-form"
                    ...
                    <div class="modal-wrapper">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <span
                                        v-if="deleteModal.errorMessage"
                                        class="text-danger"
                                        >{{ deleteModal.errorMessage }}</span
                                    >
                                    <form
                                        class="custom-form"
            ...
            paymentService.getSubscriptionInformation(stripeCustomerId).then(
                function (response) {
                    if (response) {
                        ...
                        if (price === 149 || price === 1495) {
                            this.isEnabledInvite = true;
                        } else {
                            this.isEnabledInvite = false;
                        }
                    }
                }.bind(this)
            );
